...
class KubeflowProcessProxy(ContainerProcessProxy):
    """
    ...
    def _determine_kernel_namespace(self, **kwargs):
        ...
        # get it now.
        service_account_name = KubeflowProcessProxy._determine_kernel_service_account_name(**kwargs)
    ...
    def get_process_info(self):
        ...
        process_info = super(KubeflowProcessProxy, self).get_process_info()
    ...
    def load_process_info(self, process_info):
        ...
        super(KubeflowProcessProxy, self).load_process_info(process_info)
